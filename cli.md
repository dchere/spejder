...
- Career-alert artifact commands (no LLM init): `list-career-alert-artifacts`, `disable-career-alert-artifact --id`, `enable-career-alert-artifact --id`, `promote-career-alert-artifact --id [--keep-overlay]` → `workflows.career_alert_artifacts`.
