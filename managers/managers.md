...
- `dashboard_manager.py` / `dashboard_manager.md` — interactive HTML dashboard generation (Applied / Interview / Stopped / Hidden panels; live company-feedback pre-fill via `data-company-feedback` and `ensureCompanyFeedbackUI`)
