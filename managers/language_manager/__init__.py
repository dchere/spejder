...
from .translation_config import configured_translation_slots, configured_translation_source_languages, primary_translation_slot, translation_model_path_for_language
from .utils import (_print_translation_step, _fail_translation_init, _language_checker_model_path, _language_checker_threshold, _language_checker_min_letters, _language_checker_letter_count, _language_checker_cache_key, _language_checker_model_looks_valid, _translation_model_looks_valid, _print_language_checker_step, _fail_language_checker_init)
...
from .detection import (is_danish_text, is_ukrainian_text, translation_source_language)
