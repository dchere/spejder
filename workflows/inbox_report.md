...
- `write_inbox_dashboard_report(db_path, profile, llm, report_dir) -> str` — builds Relevant / Not relevant / Applied-stage records, loads Hidden via `build_hidden_dashboard_records`, and passes `hidden_items` to `_render_html_dashboard`
